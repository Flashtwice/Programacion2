...
public class Controller {
	...
	private void menu() {
		...
		case "4":
			...
			String apellidoAReemplazar = vista.leerDato("Ingrese nuevo apellido: ");
			String cedulaAreemplazar = vista.leerDato("Ingrese el nuevo numero de cedula: ");
			int edadAReemplazar = vista.leerEntero("Ingrese nueva edad: ");
			String cargoAReemplazar = vista.leerDato("Ingrese nuevo Cargo: ");
			Candidato[] nuevoArrayActualizado = null;
			nuevoArrayActualizado = empresa.getCandidatoDAO().modificarCandidato(cedulaCandidato,nombreAReemplazar, apellidoAReemplazar,cedulaAreemplazar,edadAReemplazar,cargoAReemplazar,   empresa.getArrayCandidato());
		...
		case "5":
			String cedulaABuscar = vista.leerDato("\nIngrese la cedula del candidato a buscar: ");
				if(empresa.getCandidatoDAO().buscarCandidato(cedulaABuscar, empresa.getArrayCandidato())==true) {
					System.out.println(empresa.getArrayCandidato()); 
					menu();
			}
